						...
						?>
								<li><a href="<?php echo $HomeURL;?>/content/view_all_photogallery.php?catid=<?php echo  $fetch_result['c_id'];  ?>"><img style="width:175px; height:110px;" title=" image<?php echo $fetch_result['sortdesc']; ?>" alt="<?php echo $fetch_result['sortdesc']; ?>" src="<?php echo $image_path;?>">	</a></li>
                  <?php }  ?>
							</ul>
