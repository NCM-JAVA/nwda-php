               ...
               <div class="col-sm-9 main-content inner">
                  ...
                  <div class="photo-gallery">
                     ...
                     <div class="form-field">
                        ...
                        <?php
                           $photo_query1 = "select category.c_name,photogallery.sortdesc,photogallery.img_uplode from photogallery join category on category.c_id = photogallery.category_id where approve_status='3' and photogallery.gallery_type='1' and category.c_name!='Home Page Banner' and photogallery.category_id ='$newid' order by  photogallery.id  ASC";
                        ...
                        <div class="frame1 galleryDiv">
                           <a href="<?php echo $HomeURL . "/upload/photogallery/media/" . $fetch_result1['img_uplode'] ?>" 
                              rel="lightbox[<?php echo $categoryid ?>]" title="<?php echo $fetch_result1['sortdesc']; ?>">
                           <img src="<?php echo $image_pathnew;?>" alt="image"  border="0" title=""/></a>
                           <!-- set div -->	
                           <div class="form-field">
