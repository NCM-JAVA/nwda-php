<ul class="list-inline" id="nav">
				...
				<?php
			    $sqlquery="select * from menu_publish where m_flag_id='0'  and menu_positions='1' and menu_positions!='5' and language_id='1' and approve_status='3'  ORDER BY page_postion ASC limit 0,8";
				$sql = mysql_query($sqlquery); 
			$count=mysql_num_rows($sql);
				$i = 1;
				while ($row = mysql_fetch_array($sql)) {
				$sqlquery11="select * from menu_publish where m_flag_id='".$row['m_publish_id']."' and menu_positions!='5' and language_id='1' and approve_status='3' ORDER BY page_postion ASC";
                ...
                $sqlquery22="select * from menu_publish where m_flag_id='".$rows['m_publish_id']."' and menu_positions!='5' and language_id='1' and approve_status='3' ORDER BY page_postion ASC";
