										...
										if($errmsg == ''){
											...
											if($txtcategory=='4'){
												...
												if($txtcategory=='2'){
													...
													$query="select * from combine_publish where cat_id='2' and language_id='1' and approve_status='3' and date(end_date) <= CURDATE() - INTERVAL 6 MONTH $querywhere"."$querywh";
													...
													$query="select * from combine_publish where `cat_id`='$cat_id' and `language_id`=1 and `approve_status`=3 and date(start_date) <= CURDATE() - INTERVAL 6 MONTH $querywhere"."$querywh";
												}
											}
