...
//  mail to Admin Ends
    ...
    $msg = "Feedback send to Admin Successfully";
	...
	<section>
			...
			<div class="container">
				<div class="row">
				  ...
				  <label for="txtename" >Feedback Category:<span class="star">*</span></label>
					<div class="col-md-6" style=" margin-left: -15px; width: 30%;">
					  <select name="category" class="form-control">
					  <option value="">Select</option>
					  <option value="1">Feedback for NWDA Studies</option>
					  <option value="2">Feedback for NWDA Website</option>
					  </select>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
				  <label for="txtcomment">Comment:<span class="star">*</span></label>
...
<script>
 ...
 function validatePhone(txtPhone) {
	...
	<a href="javascript:" id="return-to-top"><img src="../images/top-arrow.png" title="Go to Top" alt="Go to Top" style="background: blue;"></a>
    <script >
    // ===== Scroll to Top ==== 
