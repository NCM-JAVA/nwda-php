...
<html lang="en">
	...
	<section>
			...
			<div class="container">
			  ...
			  if($_REQUEST['tid']!='')
			  {
			  $sqlten="select * from tender_publish where m_id='".$_REQUEST['tid']."' and language_id='2' and approve_status='3' order by m_id desc ";
			  }
			  else
			  {
				  $date=date('Y-m-d'); 
			  $sqlten="select * from tender_publish where approve_status='3' and language_id='2' and date(end_date) >= '$date' order by m_id desc ";
			  }
				...
				?>			
					<tr>
					    <td><?php  echo $m; ?></td>
						<td><?php  echo $rowten['m_name']; ?><img src="<?php echo $HomeURL?>/images/new.gif" style="width:50px;"></td>
