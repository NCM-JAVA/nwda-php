	...
	<div id="main-nav" class="navigation-bg">
		<nav>
			<div>
				...
				<?php
			    $sqlquery="select * from menu_publish where m_flag_id='0'  and menu_positions='1' and language_id='2' and approve_status='3'  ORDER BY page_postion ASC limit 0,10";
				$result = $conn->query($sqlquery);
			// $count=mysql_num_rows($sql);
				$i = 1;
				while($row = $result->fetch_array()) {
				$sqlquery11="select * from menu_publish where m_flag_id='".$row['m_publish_id']."' and menu_positions='1' and language_id='2' and approve_status='3' ORDER BY page_postion ASC";
                ...
                $sqlquery22="select * from menu_publish where m_flag_id='".$rows['m_publish_id']."' and menu_positions='1' and language_id='2' and approve_status='3' ORDER BY page_postion ASC";
...
if($rowssub['m_type']=='1'){ $pageurlh2='<a title="'.$rowssub['m_name'].'" href="'.$HomeURL.'/contenthi/innerpage/'.$rowssub['m_url'].'">'.$rowssub['m_name'].'</a>'; }
