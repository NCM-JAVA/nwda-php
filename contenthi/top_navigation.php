	<div class="container nav-container">
        ...
        <li class="active"><a title="Home" href="<?php echo $HomeURL; ?>/contenthi/index.php"><i class="fa fa-home"></i></a></li>
        <?php
            ...
            $m_id=$row['m_id'];
            if($row['m_type']=='1'){ $pageurlh='<a title="'.$row['m_name'].'" href="'.$HomeURL.'/contenthi/page/'.$row['m_url'].'">'.$row['m_name'].'</a>'; }
            ...
            ?>
             ...
             <?php if($row2 > 0){
				...
				<?php 	
					...
					{
					if($rows['m_type']=='1'){ $pageurlh1='<a title="'.$rows['m_name'].'" href="'.$HomeURL.'/contenthi/page/'.$rows['m_url'].'">'.$rows['m_name'].'</a>'; }
		...
		if($rows['m_type']=='3'){  $pageurlh1='<a title="'.$rows['m_name'].'" target="_blank" href="'.$rows['linkstatus'].'">'.$rows['m_name'].'</a>'; } ?>
				...
				<?php 	
					...
					{
					if($rows['m_type']=='1'){ $pageurlh2='<a title="'.$rows3['m_name'].'" href="'.$HomeURL.'/contenthi/page/'.$rows3['m_url'].'">'.$rows3['m_name'].'</a>'; }
