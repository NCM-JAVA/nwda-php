			...
			<div class="container">
				<div class="row">
					...
					<div class="">
						...
						<?php  $sqlnews="select * from combine_publish where m_id='".$_REQUEST['nid']."'  and  cat_id='2' and approve_status='3' order by m_id desc";
                    $resnews=mysql_query($sqlnews) or die(mysql_error());
					$rownews=mysql_fetch_array($resnews);
				
				?>	
				<p><b><?php  echo $rownews['m_name']; ?></b></p>
			
						<p><?php  echo strip_tags($rownews['m_content']); ?></p>
