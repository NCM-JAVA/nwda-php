...
<section id="fontSize" class="wrapper body-wrapper">
  ...
  <li class="first"><?php echo "<a href=".$HomeURL."/content/>Home</a>"?></li>
			<span> &nbsp;>></span> Tender / Advertisement
</ul>
  ...
  <div class="inner-bg-wrapper">  
   <div class="container">     
    ...
    <div class="inner_right_container">
     <h1>Tender / Advertisement</h1>
      
<table>
    <caption>Tender / Advertisement</caption>
  <tbody>
...
<?php  
$date=date('Y-m-d');
$sql_tender=mysql_query("select * from combine_publish where cat_id='4' and language_id='2' and approve_status='3' and date(end_date) >='$date'");
