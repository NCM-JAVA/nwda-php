...
<html lang="en">
	<head>
		<title>क्या नया है: राष्ट्रीय जल विकास एजेंसी</title>
		<meta charset="utf-8">
	...
	<section>
			...
			<div class="container">
				...
				<?php  
					...
					{
				?>	
						<p><b><a href="news-details.php?nid=<?php  echo $rownews['m_id'];  ?>"><?php  echo $rownews['m_name'].". Published On: ".date('d-m-Y',strtotime($rownews['start_date'])); ?></a></b></p>
				<?php }  ?>		
