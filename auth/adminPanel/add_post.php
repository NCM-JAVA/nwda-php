...
$tableFieldsName_old=array("language_id","postname","advertisement_no","post_type","salary","percentage","p_percentage","gen","obc","scst","genph","obcph","scstph","exservice","others","incan","exservice_OBC","exservice_SCST","exservice_PH","exservice_GENPH","exservice_SCSTPH","exservice_OBCPH","age","ddamount","totalexp","phsubcat","startdate","starttime","expairydate","expairytime","txtcontentdesc","post_level","approve_status","txtuplode");
// die("kk");
$tableFieldsValues_send=array(
			...
			$txtuplode);
			// echo "<pre>";
			// print_r($tableFieldsValues_send);die("22");
		  ...
		  <div class="frm_row"> <span class="label1">
			...
			<div class="frm_row">
				<span class="label1">
              	...
              	<span class="input1">
             		<input name="advertisement_no" type="text" class="input_class" id="advertisement_no" size="50" value="<?php if(htmlspecialchars(content_desc($advertisement_no!=""))) { echo htmlspecialchars($advertisement_no);} ?>" autocomplete = "off" placeholder="Advertisement No." required/>
             	</span>
				<div class="clear"></div>
			</div>
