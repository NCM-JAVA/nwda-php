...
if ($deleteid != '') {
    ...
    if ($check_status > 0) {
        ...
        // $sqd = "select image_file FROM manage_vacancy WHERE id=$deleteid";
        $sql = "Delete From vacancy where id='$deleteid'";
...
if ($inactiveid != '') {
    ...
    //    $sql="Update manage_vacancy set status='1' where id='$inactiveid'";
    $sql = "Update vacancy set approve_status='1' where id='$inactiveid'";
    $res = mysqli_query($conn, $sql);
    //   $sql="Update manage_vacancy set status='1' where m_publish_id='$inactiveid'";
//  $res=mysqli_query($conn, $sql);
...
<head>
    ...
    <title>Manage Vacancy: <?php echo $sitename; ?></title>
        ...
        <div class="main_con">
            ...
            <div class="right_col1">
                ...
                if ($btnsubmit == "Search") {
                    if ($filter_search != '') {
                        if (preg_match("/^[aA-zZ][a-zA-Z -]{2,20}+$/", trim($filter_search)) == 0) {
                            ...
                            $querywhere .= " and v_title LIKE '%$filter_search%'";
                        }
                    }
                    // if ($texcat != '') {
                    //     $querywhere .= " and category_id=$texcat";
                    // }
                    if ($txtstatus == '') {
                    ...
                    if ($errmsg == '') {
                        // $query ="select * from manage_vacancy where 1  $querywhere ORDER BY id ASC "; 
                        $query = "select * from vacancy where 1  $querywhere ORDER BY id ASC ";
                    } else {
                    ...
                    //    $query ="select * from manage_vacancy where 1  $wherecluse ORDER BY id ASC ";
                    $query = "select * from vacancy where 1  $wherecluse ORDER BY id ASC ";
                }
                ...
                <?php if ($_SESSION['errors'] != "") { ?>
                    <div id="msgerror" class="status error">
                        <div class="closestatus" style="float: none;">
                            <p class="closestatus" style="float: right;"><img alt="Attention" src="images/close.png"
                                    class="margintop"></p>
                            <p><img alt="error" src="images/error.png"> <span>Attention!
                                    <br /></span><?php echo $_SESSION['errors'];
                                    $_SESSION['errors'] = ""; ?></p>
                        </div>
                    </div>
                <?php } ?>
                ...
                <div class="internalpage_heading">
                    <h3 class="manageuser">Manage Vacancy</h3>
                    <div class="right-section">
                        ...
                        <ul>
                            ...
                            <?php if ($role_map['draft'] == 'DR' || $user_id == '101') { ?>
                                <li class="new-icon">
                                    <a href="vacancy.php" title="New"><span class="icon-28-new"></span>New</a>
                                </li>
                            <?php } ?>
                            <?php if ($role_map['medit'] == 'ED' || $user_id == '101') { ?>
                                <li id="editer" class="edit-icon"><a href="#"
                                        onclick="alert('Please Select Manage Vacancy ')" title="Edit">Edit</a><?php } ?>
                            </li>
                            <?php if ($role_map['mdelete'] == 'DE' || $user_id == '101') { ?>
                                <?php if ($txtstatus != '3') { ?>
                                    <li id="delete" class="delete-icon"><a href="#"
                                            onclick="alert('Please Select Manage Vacancy')" title="Delete">Delete</a></li>
                                <?php }
                            } ?>
                        </ul>
                        ...
                        <div class="new-gried">
                            ...
                            <form id="manage_menu" name="manage_menu" method="post" action="">
                                <div class="filter-select fltrt">
                                    ...
                                    <input id="filter_search" type="text" title="Search title or Menu Name." value=""
                                        name="filter_search">
                                    <!-- <select name="texcat" id="texcat" autocomplete="off">
                                        ...
                                        foreach ($categoryList as $key => $value) {
                                            ?>
                                            <option value="<?php echo $value['c_id']; ?>" <?php if ($value['c_id'] == $texcat) {
                                    ...
                                    <select name="txtstatus" id="txtstatus" class="inputbox" autocomplete="off">
                                        ...
                                        <?php if ($role_map['pending'] == 'PND') { ?>
                                            <option value="5" <?php if ($txtstatus == '5')
                                                echo 'selected="selected"'; ?>>
                                                Pending</option>
                                        <?php }
                                        if ($role_map['draft'] == 'DR' || $user_id == '101' || $user_id == '104') { ?>
                                            <option value="1" <?php if ($txtstatus == '1')
                                                echo 'selected="selected"'; ?>>Draft
                                            </option>
                                        <?php }
                                        if ($role_map['mapprove'] == 'AP' || $user_id == '101' || $user_id == '104') { ?>
                                            <option value="2" <?php if ($txtstatus == '2')
                                                echo 'selected="selected"'; ?>>
                                                Approval</option>
                                        <?php }
                                        if ($role_map['publish'] == 'PB' || $user_id == '101' || $user_id == '104') { ?>
                                            <option value="3" <?php if ($txtstatus == '3')
                                                echo 'selected="selected"'; ?>>
                                                Publish</option>
                                    ...
                                    <select class="inputbox" name="btneng">
                                        <option value="English" <?php if ($_SESSION['lname'] == 'English')
                                            echo 'selected=selected' ?>>English</option>
                                            <option value="Hindi" <?php if ($_SESSION['lname'] == 'Hindi')
                        ...
                        <div class="tab-container" id="outer-container" style="padding:5px 5px -12px  0px">
                            <div class="grid_view">
                                ...
                                <div id="list">
                                    ...
                                    <ul class="">
                                        ...
                                        while ($data = $result->fetch_array()) {
                                            ...
                                            <li id="arrayorder_<?php echo $id ?>" class="<?php echo $class; ?>">
                                                ...
                                                <span class="space-menuname_m" style="width:25%;"><input type="radio"
                                                        name="radio1" id="<?php echo $id; ?>" value="<?php echo $id; ?>"
                                                        onclick="editlist(this.value);">&nbsp;&nbsp;
                                                    <?php echo $v_title; ?></span>

                                                <span class="space-lang" style="width:25%;"><?php status($approve_status); ?></span>

                                                <span class="space-option"
                                                    style="width:25%;"><?php language($language_id); ?></span>
                                                
                                                <span class="space-option" style="width:25%;">
                                                    <?php if ($role_map['publish'] == 'PB' || $approve_status == 3) { ?>
                                                        <a href="manage_vacancy.php?inactiveid=<?php echo $id; ?>&random=<?php echo $_SESSION['logtoken']; ?>"
                                                            onclick="return confirm('Are you sure you want to Inactive this page?')"
                                                            title="Inactive">Inactive</a>&nbsp;/&nbsp;<?php } ?>
                                                    <a href="#" class="cat_link" title="View"
                                                        onclick="MM_openBrWindow('vacancyview.php?page_id=<?php echo $id; ?>','window','width=1000,height=600,scrollbars=yes')">View
                                                    </a>
                                                </span>
                                                <div class="clear"></div>
                                            </li><?php } ?>
                                    ...
                                    <ul>
                                        <li class="page" style="text-align:center;"><?php echo $pager->renderFullNav(); ?>
                                        </li>
                                    </ul>
                                <?php } else { ?>
                                    <ul>
                ...
                jQuery.ajax({
                    ...
                    success: function (pub) {
                        ...
                        if (dataid == 0) {
                            ...
                            var d = '<a href="manage_vacancy.php?deleteid=' + dataid + '&random=<?php echo $_SESSION['logtoken']; ?>" onclick="return confirm(\'Are you sure you want to delete this record permanently?\');" title="Delete"><span class="icon-28-delete"></span>Delete</a>';
