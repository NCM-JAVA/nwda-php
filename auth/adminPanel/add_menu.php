...
ini_set('display_errors', 1);
 ...
 $txtsl = 0;
	$insert_sql = "INSERT INTO `menu`(`m_flag_id`,`m_type`,`menu_positions`,`language_id`,`m_name`,`m_url`,`m_title`,`m_keyword`,`m_description`,`content`,`doc_uplode`,`linkstatus`,`start_date`,`end_date`,`create_date`,`update_date`,`approve_status`,`admin_id`,`page_postion`,`current_version`,`upload_img`)VALUES('$menucategory','$texttype','$txtpostion','$txtlanguage','$txtename','$url','$page_url','$txtekeyword','$txtmeta_description','$txtcontentdesc','$txtuplode','$link','$startdate','$expairydate','$createdate','$createdate','$txtstatus','$user_id','$txtsl','0','$txtuplode1')"; 
...
// Display errors in the browser
ini_set('display_errors', 1);
	$tablesql = "INSERT INTO `menu_publish`(`m_type`,`m_publish_id`,`m_flag_id`,`menu_positions`,`language_id`,`m_name`,`m_url`,`m_title`,`m_keyword`,`m_description`,`content`,`doc_uplode`,`linkstatus`,`start_date`,`end_date`,`create_date`,`update_date`,`approve_status`,`admin_id`,`page_postion`,`current_version`,`upload_img`)VALUES('$texttype','$page_id','$menucategory','$txtpostion','$txtlanguage','$txtename','$url','$page_url','$txtekeyword','$txtmeta_description','$txtcontentdesc','$txtuplode','$link','$startdate','$expairydate','$createdate','2025-01-01 00:00:00','$txtstatus','$user_id','$txtsl','$version','$txtuplode1')";
