<?php ob_start();
	...
	if(isset($cmdsubmit) && $_GET['editid']=='')
	{
		...
		$eventhi 			= content_desc($_POST['eventhi']);
		...
		if($txtlanguage=='2'){
			...
			if(trim($cat_id)=="3"){
				...
				if ($_FILES["txtuplode"]["name"]== ""){
					$errmsg .="Please Upload Image File."."<br>";
				}
		...
		if($errmsg == ''){
			...
			$tableFieldsName_old=array("language_id","cat_id","m_name","m_short","m_title","m_content","page_url","start_date","end_date","approve_status","admin_id","c_new_status","image_file","create_date","docs_file","ext_url","content_type","more_photo","m_keyword","m_description","eventhi","whatsNew_cat");
			$tableFieldsValues_send=array("$txtlanguage","$cat_id","$txtename","$sortcontentdesc","$m_title","$txtcontentdesc","$url","$startdate","$expairydate","$txtstatus","$user_id","$newicons","$image_file","$createdate","$txtuplodepdf","$txtweblink","$texttype","$addphoto","$txtekeyword","$txtmeta_description","$eventhi","$txtcategory"); 
			$value=$useAVclass->insertQuery($tableName_send,$tableFieldsName_old,$tableFieldsValues_send);
			*/
      
      //$abc = "ALTER TABLE combine_publish MODIFY more_photo VARCHAR(255) NULL;";
      //$abc2 = $conn->query($abc);
      ...
      //ini_set('display_errors', 1);
       ...
       $txtcategory = 0;
			...
			$consql = "INSERT INTO `combine` (`language_id`,`cat_id`,`m_name`,`m_short`,`m_title`,`m_content`,`page_url`,`start_date`,`end_date`,`approve_status`,`admin_id`,`c_new_status`,`image_file`,`create_date`,`docs_file`,`ext_url`,`content_type`,`more_photo`,`m_keyword`,`m_description`,`eventhi`,`whatsNew_cat`)VALUES('$txtlanguage','$cat_id','$txtename','$sortcontentdesc','$m_title','$txtcontentdesc','$url','$startdate','$expairydate','$txtstatus','$user_id','$newicons','$image_file','$createdate','$txtuplodepdf','$txtweblink','$texttype','$addphoto','$txtekeyword','$txtmeta_description','$eventhi','$txtcategory')";

			$rsdfgh = $conn->query($consql); 
			$page_id=$conn->insert_id;

			/* 
			$tableName_send="category";
			$tableFieldsName_old=array("c_name","c_namehi","c_status","cat_id","event_id","event_url");
			$tableFieldsValues_send=array("$txtename","$eventhi","1","1","$page_id","$url");
			$value=$useAVclass->insertQuery($tableName_send,$tableFieldsName_old,$tableFieldsValues_send); */

		/* 	$con2 = "INSERT INTO `category` (`c_name`,`c_namehi`,`c_status`,`cat_id`,`event_id`,`event_url`)VALUES('$txtename','$eventhi','1','1','$page_id','$url')";
			$rds1 = $conn->query($con2); */

			if($txtstatus=='3'){
				$sql="INSERT INTO combine_publish (m_publish_id,language_id,cat_id,m_name,m_short,m_title,m_content,page_url,start_date,end_date,approve_status,admin_id,c_new_status,create_date,image_file,docs_file,ext_url,content_type,more_photo,m_keyword,m_description,eventhi)
				SELECT m_id, language_id,cat_id,m_name,m_short,m_title,m_content,page_url,start_date,end_date,approve_status,admin_id,c_new_status,create_date,image_file,docs_file,ext_url,content_type,more_photo,m_keyword,m_description,eventhi
			...
			$auditcon2 = "INSERT INTO `audit_trail` (`user_login_id`,`page_id`,`page_name`,`page_action`,`page_category`,`page_action_date`,`ip_address`,`lang`,`page_title`,`approve_status`)VALUES('$user_id','$page_id','$txtename','$action','$model_id','$date','$ip','$txtlanguage','$txtepage_title','$txtstatus')";
			$rds = $conn->query($auditcon2);

	
			$msg='Circular has been added successfully';
	...
	if(isset($cmdsubmit) && $_GET['editid']!=''){
		...
		if($errmsg == ''){
			...
			if ($_FILES["txtuplodepdf"]["name"]!=""){	
				...
				$useAVclass->UpdateQuery($tableName_send,$whereclause,$old,$new); */
				 $sql_uptp = "UPDATE `combine` SET `docs_file`='$txtuplodepdf' WHERE `m_id`=$cid";
				$resultsss = $conn->query($sql_uptp);
			}	
			...
			$tableName_send="combine";
				/* 
				$old=array("language_id","cat_id","m_name","m_short","m_title","m_content","page_url","start_date","end_date","approve_status","admin_id","c_new_status","create_date","ext_url","content_type","more_photo","m_keyword","m_description","update_date","eventhi","whatsNew_cat");
				$new=array("$txtlanguage","$cat_id","$txtename","$sortcontentdesc","$m_title1","$txtcontentdesc","$url","$startdate","$expairydate","$txtstatus","$user_id","$newicons","$create_date","$txtweblink","$texttype","$addphoto","$txtekeyword","$txtmeta_description","$update_date","$eventhi","$txtcategory");
				$useAVclass->UpdateQuery($tableName_send,$whereclause,$old,$new); */
	    ...
	    error_reporting(E_ALL);
         ...
         $txtcategory = 0;        
			...
			$sql1 = "UPDATE `combine` SET `language_id`='$txtlanguage',`cat_id`='$cat_id',`m_name`='$txtename',`m_short`='$sortcontentdesc',`m_title`='$title',`m_content`='$txtcontentdesc',`page_url`='$url',`start_date`='$startdate',`end_date`='$expairydate',`approve_status`='$txtstatus',`admin_id`='$user_id',`c_new_status`='$newicons',`create_date`='$create_date',`update_date`='$update_date',`whatsNew_cat`='$txtcategory' WHERE `m_id`=$cid";
			$result = $conn->query($sql1);

			$tableName_send="category";
			$whereclause="event_id=$cid";
				/* 	$old =array("c_name","c_namehi","c_status","cat_id","event_url");
				$new =array("$txtename","$eventhi","1","1","$url");
				$useAVclass->UpdateQuery($tableName_send,$whereclause,$old,$new); */

		/* 	$sql19876 = "UPDATE `category` SET `c_name`='$txtename',`c_namehi`='$eventhi',`c_status`='1',`cat_id`='1',`event_url`='$url' WHERE `event_id`=$cid";
			$result234 = $conn->query($sql19876); */


			if($txtstatus=='3'){
				$tableName_send="combine_publish";
				$whereclause="where m_publish_id='$cid'";
				$sqlxxx=mysqli_query($conn, "Select * from combine_publish $whereclause");
				$row=mysqli_num_rows($sqlxxx); 

				if($create_version==1 and $row >0){
					$sql="INSERT INTO combine_publish_versions (m_publish_id,language_id,cat_id,m_name,m_short,m_title,m_content,page_url,start_date,end_date,approve_status,admin_id,c_new_status,create_date,image_file,docs_file,ext_url,content_type,more_photo,m_keyword,m_description,create_versions_date,eventhi,whatsNew_cat)
					SELECT m_publish_id, language_id,cat_id,m_name,m_short,m_title,m_content,page_url,start_date,end_date,approve_status,admin_id,c_new_status,create_date,image_file,docs_file,ext_url,content_type,more_photo,m_keyword,m_description,update_date,eventhi,whatsNew_cat FROM combine_publish WHERE m_publish_id=$cid";
					mysqli_query($conn, $sql);
				}

				if($row >0){
					$update="UPDATE combine_publish JOIN combine ON combine_publish.m_publish_id = combine.m_id SET combine_publish.m_publish_id = combine.m_id,combine_publish.language_id = combine.language_id,combine_publish.cat_id = combine.cat_id,combine_publish.m_name = combine.m_name,combine_publish.m_short = combine.m_short,combine_publish.m_title = combine.m_title,combine_publish.m_content = combine.m_content,combine_publish.page_url = combine.page_url,combine_publish.start_date = combine.start_date,combine_publish.end_date = combine.end_date,combine_publish.approve_status = combine.approve_status,combine_publish.admin_id = combine.admin_id,combine_publish.c_new_status = combine.c_new_status,combine_publish.create_date = combine.create_date,combine_publish.image_file = combine.image_file,combine_publish.docs_file = combine.docs_file,combine_publish.ext_url = combine.ext_url,combine_publish.content_type = combine.content_type,combine_publish.more_photo = combine.more_photo,combine_publish.m_keyword = combine.m_keyword,combine_publish.m_description = combine.m_description,combine_publish.update_date = combine.update_date,combine_publish.eventhi = combine.eventhi,combine_publish.whatsNew_cat=combine.whatsNew_cat WHERE combine_publish.m_publish_id =combine.m_id and combine.m_id=$cid";
        	mysqli_query($conn, $update);
				}else {
					$sql="INSERT INTO combine_publish (m_publish_id,language_id,cat_id,m_name,m_short,m_title,m_content,page_url,start_date,end_date,approve_status,admin_id,c_new_status,create_date,image_file,docs_file,ext_url,content_type,more_photo,m_keyword,m_description,update_date,eventhi,whatsNew_cat)
					SELECT m_id, language_id,cat_id,m_name,m_short,m_title,m_content,page_url,start_date,end_date,approve_status,admin_id,c_new_status,create_date,image_file,docs_file,ext_url,content_type,more_photo,m_keyword,m_description,update_date,eventhi,whatsNew_cat
			...
			$auditcon3= "INSERT INTO `audit_trail` (`user_login_id`,`page_id`,`page_name`,`page_action`,`page_category`,`page_action_date`,`ip_address`,`lang`,`page_title`,`approve_status`)VALUES('$user_id','$page_id','$txtename','$action','$model_id','$date','$ip','$txtlanguage','$txtepage_title','$txtstatus')";
			$rds = $conn->query($auditcon3);
		
			//$msg=CONTENTADD;
			$msg='Circular details Updated Successfully';
			$_SESSION['content']=$msg;
			header("location:manage_circular_events.php");
			exit;	
		}
...
<title>Manage Circular / Events / News : <?php echo $sitename;?></title>
<!-- admin css  -->
...
<div class="breadcrum">
  <span class="submenuclass"><a href="welcome.php" title="Dashboard">Dashboard</a></span>
			...
			<span class="submenuclass"><a href="manage_circular_events.php" title="Manage Circular / Events">Manage Circular / Events</a></span>
			 <span class="submenuclass">>> </span> 
			<span class="submenuclass">Add/Update Circular / Events / News</span>	</div>
<div class="clear"> </div>
</div>  
...
<p><img alt="error" src="images/error.png"> <span>Attention! <br /></span><?php echo $errmsg; ?></p>
 ...
 <h3 class="manageuser">Add/Update Circular / Events / News </h3>
...
<div id="txtevent"<?php if($texcat=='3' || $rr['cat_id']=='3' || $rr['cat_id']=='5') {?> style="display:block" <?php } else {?>style="display:none" <?php } ?>>
<div class="frm_row"> <span class="label1">
				<label for="eventhi">Event Name (Hindi)</label>
				<span class="star">*</span></span> <span class="input1">
				<input name="eventhi" autocomplete="off" type="text" class="input_class" id="eventhi" size="30"   value="<?php echo $rr['eventhi']; ?>"/>				
				</span>
				<div class="clear"></div>
			</div>
<div class="frm_row"> <span class="label1">
   ...
   <div class="frm_row"> <span class="label1">
		...
		<span class="date"><strong>Example : https://www.xyz.com</strong></span>
            ...
            <div class="clear"></div>
				...
				<?php /*	<div class="frm_row"> <span class="label1">
					...
					<input type="text" name="startdate" id="startdate" readonly="readonly"  autocomplete="off" value="<?php if($rr['start_date'] !=''){ echo changeformate($rr['start_date']); } else { } ?>"/><span class="date">[dd-mm-yyyy]</span> 
							...
							<div class="clear"></div>
                                                ...
                                                <div class="frm_row"> <span class="label1">
                                                        <label for="expairydate">Published Date:</label><span class="star">*</span>
                                                    </span> <span class="input1">
                                                        <input type="text" name="expairydate" autocomplete="off" readonly="readonly"  id="expairydate" value="<?php if($rr['end_date'] !=''){  echo changeformate($rr['end_date']); }else {}?>"/><br><span class="date">[dd-mm-yyyy]</span> 
