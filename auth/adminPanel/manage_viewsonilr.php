...
<html>
<head>
<title>Manage Views On ILR : <?php echo $sitename; ?></title>
        ...
        <div class="right_col1">
            <div class="clear"></div>
				...
				if($btnsubmit=="Search")
				{
					...
					if($errmsg=='')	
					{
						$query ="select id,name,email,phone,review_comment,review_date from viewsonilr  where review_comment IS NULL $querywhere $datef ORDER BY id DESC";
...
<p><img alt="error" src="images/error.png"> <span>Attention! <br /></span><?php echo $_SESSION['errors']; $_SESSION['errors']="";?></p>
 ...
 <?php if($_SESSION['admin_auto_id_sess']=='101'){ ?>
	<!-- <li>
		<a href="download_viewsonilr_excel.php" title="Export Views On ILR"><span class="icon-28-new"></span>Export Views On ILR</a>
	</li> -->
	
	<li>
		<a href="archive_viewsonilr.php" title="Archive"><span class="icon-28-new"></span>Archive</a>
	</li>
...
<!-- Container div-->
  ...
  <script type="text/javascript">
		  function getUrl(id) {
			  ...
			  document.getElementById('edit').href='edit_viewsonilr.php?editid='+id+'<?php echo $pagnn; echo '&'.$string_url;?>';
		  }
	  </script>
