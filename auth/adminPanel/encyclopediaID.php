...
$sql= "SELECT MessageID,Message,Author,DATE_FORMAT(CreationDate, '%b %d %Y %h:%i %p') AS mydatestring,m_status,Email FROM encyclopedia_messagelist WHERE 1 and MessageID='$page_id'"; 
