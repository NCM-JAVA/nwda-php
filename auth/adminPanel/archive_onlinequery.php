...
<head>
<title>Archive Online Query: <?php echo $sitename; ?></title>
...
function editlist(id) {
	...
	$('#loading').hide(); 
		...
		{
            //hide the progress bar
			var e='<a href="edit_onlinequery.php?editid='+dataid+'" title="Edit"><span class="icon-28-edit"></span>Reply</a>';
            ...
            <div class="clear"></div>
				...
				if($btnsubmit=="Search")
				{
					...
					if($errmsg=='')	
					{
						...
						$query ="select id,name,email,review_comment,review_date from onlinequery_form  where review_comment IS NULL";
					
					}
				}else{
					$query ="select id,name,email,review_comment,review_date from onlinequery_form  where review_comment IS NOT NULL";
				}
...
<p><img alt="error" src="images/error.png"> <span>Attention! <br /></span><?php echo $_SESSION['errors']; $_SESSION['errors']="";?></p>
 ...
 <ul>
			 ...
			 <a href="manage_onlinequery.php"></span>Back</a>
			  </li>
...
<table width="100%" border="1" cellspacing="2" cellpadding="2" summary="" >
  ...
  <div id="list">
    <div id="response"> </div>  
		<?php	
		$pager = new PS_Pagination($link, $result,"txtlanguage=$language");
		$rs = $pager->paginate();
		$result->num_rows;
		...
		<span class="space-lang"><?php echo $contact_no; ?></span>	
