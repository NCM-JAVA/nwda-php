...
$edit_contrator ="select * from photogallery where id='$page_id'";
...
<td align="left" class="label2"  width="25%">
 <?php if($img_uplode!='' && $gallery_type=='1') {?>Image: </td><td width="1%">:</td>
		  	 ...
		  	 <img src="../../upload/photogallery/media/thumb/<?php echo $img_uplode;?>" alt="" title="" align="center" width="80" height="90" />
		       </span>
            <div class="clear"></div>
            </div>
			</label>
	...
	<tr>
		<td align="left" valign="top" width="35%" class="label2" >Created date: </td><td width="1%">:</td>
		<td align="left" width="64%" class="label1"><label for="select"></label><label for="member">
