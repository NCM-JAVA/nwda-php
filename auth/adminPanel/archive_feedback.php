        ...
        <div class="right_col1">
            <div class="clear"></div>
				...
				if($btnsubmit=="Search"){
					...
					if($errmsg==''){
						$query ="select id,name,email,review_comment,review_date from feedback_form  where review_comment IS NULL";
					}
				}else{
					$query ="select id,name,email,phone,review_comment,review_date,create_date from feedback_form  where review_comment IS NOT NULL";
				}
...
<table width="100%" border="1" cellspacing="2" cellpadding="2" summary="" >
	...
	<tr class="<?php echo $class;?>">
		...
		<td><?php echo $name; 
		if($review_comment != ''){
			echo " "."<strong><i>(Replied on $review_date)</i></strong>";
		}
		?></td>
