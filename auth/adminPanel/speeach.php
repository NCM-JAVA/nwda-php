...
$sql=mysql_query("Select * from combine_publish $whereclause");
...
<title>Manage Minister Speech add/update: <?=$sitename; ?></title>
<!-- admin css  -->
...
<div class="breadcrum">
  <span class="submenuclass"><a href="welcome.php" title="Dashboard">Dashboard</a></span>
			...
			<span class="submenuclass"><a href="minister_speech.php" title="Manage Minister Speech ">Manage Minister Speech </a></span>
			 <span class="submenuclass">>> </span> 
			<span class="submenuclass">Add/Update Minister Speech </span>	</div>
<div class="clear"> </div>
</div>  
...
<p><img alt="error" src="images/error.png"> <span>Attention! <br /></span><?php echo $errmsg; ?></p>
 ...
 <h3 class="manageuser">Add/Update Minister Speech </h3>
...
<form action="" method="post" name="form1"  autocomplete="off" enctype="multipart/form-data"  onsubmit="return add_cp('form1')">
	...
	if($_GET['editid']!='')
	{
		$rq = mysql_query("select * from combine where 	m_id='".$_GET['editid']."' and 	cat_id=7");
...
<div id="txtweb"<?php if($texttype=='3' || $rr['content_type']=='3') {?> style="display:block" <?php } else {?>style="display:none" <?php } ?>>
   <div class="frm_row"> <span class="label1">
	...
	?>
		...
		<input type="button" class="button" value="Back" onClick="javascript:location.href ='minister_speech.php';" />
         </span>
              <div class="clear"></div>
            </div>
