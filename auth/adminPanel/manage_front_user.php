<?php 
	...
	if($deleteid !=''){
		...
		if(($deleteid!='') and ($role_id==0)){
   			...
   			if($res){	
				header("location:delete.php?status=front_deleteid");
   			}
   		}
	}
   	...
   	if($btnsubmit=="Search"){
		...
		if($errmsg==''){ 
			$sqlquery = "select * from signup where  1 $querywhere  order by user_name ASC";
		}else{
   			$_SESSION['errors']=$errmsg;
   		}	
	}else{
		$sqlquery = "select * from signup order by user_name ASC";
	}
   ?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Manage Employee : <?php echo $sitename; ?></title>
				...
				$.ajax({
					...
					success: function (pub) { 
						...
						if(dataid==0){
							...
							var e='<a href="edit_front_user.php?editid='+dataid+'" title="Edit"><span class="icon-28-edit"></span>Edit</a>';
							var d='<a href="manage_front_user.php?deleteid='+dataid+'&random=<?php echo $_SESSION['logtoken'];?>" onclick="return confirm(\'Are you sure you want to delete this record permanently?\');" title="Delete"><span class="icon-28-delete"></span>Delete</a>';
				...
				<div class="main_con">
					<div class="admin-breadcrum">
						<div class="breadcrum">
							...
							<span class="submenuclass">>> </span>
							<span class="submenuclass">Manage Employee</span>
						</div>
						<div class="clear"> </div>
					</div>
					...
					<div class="right_col1">
						...
						<div  id="msgclose" class="status success">
							<div class="closestatus" style="float: none;">
								...
								<p><img alt="Attention" src="images/approve.png" class="margintop"> <span>Attention! </span><?php echo $_SESSION['manage_user']; $_SESSION['manage_user']=""; ?>.</p>
							</div>
						</div>
						...
						<div class="internalpage_heading">
							<h3 class="manageuser">Manage Employee</h3>
							<div class="right-section">
								<ul>
								<?php if($_SESSION['admin_auto_id_sess']=='101'){ ?>
									<li class="new-icon"><a href="add_front_user.php" title="New"><span class="icon-28-new"></span>New</a></li>
						...
						<div class="tab-container" id="outer-container"  style="padding:5px 5px -12px  0px">
							<div class="grid_view">
								...
								<tr class="<?php echo $class;?>">
									<td align="left" ><input  id="<?php echo $id; ?>" type="radio" name="radio1"  onclick="editlist(this.value);"  value="<?php echo $id; ?>">	</td>
									<td  align="center" class="" ><?php echo $i++; ?> </td>
									<td  align="left" class="black-text1" ><?php echo ucfirst($user_name); ?> </td>
									<td  align="center"><?php echo ucfirst($user_phone); ?></td>
									<td  align="left"><?php echo $user_email; ?></td>
									<td  align="left"><?php echo $designation; ?></td>
									<td  align="center"><?php echo $user_status; ?></td>
								   <td  align="center" >
									  &nbsp;&nbsp;
									  <a href="#" class="" title="View" onclick="MM_openBrWindow('front_userview.php?page_id=<?php echo $id?>','window','width=650,height=300,scrollbars=yes')">View</a>				
								   </td>
								</tr>
                        <?php
                           }
