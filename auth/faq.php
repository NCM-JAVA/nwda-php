...
<div class="col-sm-12 inner-container" id="abc">
			...
			<?php  $sqlfaq="select * from faq where approve_status='3' order by f_id desc";
                   $resfaq=mysql_query($sqlfaq) or die(mysql_error());
				   while($rowfaq=mysql_fetch_array($resfaq))
				   {
				   echo $rowfaq['$description'];
				?>	
				<li>
				<p><b><?php  echo $rowfaq['title']; ?></b></p>
						<p><?php  echo stripslashes(html_entity_decode($rowfaq['description']));  ?></p>
