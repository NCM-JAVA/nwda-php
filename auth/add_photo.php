				...
				<?php }?>	
					...
					<div class="addmenu"> 
						...
						<div class="grid_view">
							...
							<th width="63" align="center" valign="top" bgcolor="whitesmoke" class="topheader_td">View Photo</th>
							</tr>
							<?php 
							$columns = "select * ";
							...
							<td width="47" align="center" class="left-tdtext"><a href="gallery-category.php?id=<?php echo $data['c_id'];?>" class="bluelink"><input type="image" border="0" alt="Edit" src="images/edit.png"  title="Edit" /></a></td>
							...
							<td width="63" align="center" class="left-tdtext"><a href="photo_by_category_id.php?cat_id=<?php echo $data['c_id'];?>" class="bluelink"><input type="image" alt="View Photo" title="view photo" src="<?php echo $HomeURL?>/images/extlink.png">View Photo</a></td>
							</tr>
							<?php } ?>
							<tr>
